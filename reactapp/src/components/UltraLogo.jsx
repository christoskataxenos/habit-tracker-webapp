...
const UltraLogo = () => (
    <div className="relative w-10 h-10 flex items-center justify-center opacity-90">
        <svg viewBox="0 0 100 100" fill="none" className="w-full h-full relative z-10">
            <path d="M50 10 C50 10, 55 45, 90 50 C55 55, 50 90, 50 90 C50 90, 45 55, 10 50 C45 45, 50 10, 50 10 Z" fill="url(#platinumGradient)" stroke="rgba(255,255,255,0.5)" strokeWidth="0.5" />
            <defs>
