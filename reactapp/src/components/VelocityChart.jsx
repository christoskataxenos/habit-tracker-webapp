...
export default function VelocityChart({ entries }) {
    ...
    return (
        <div className="w-full h-24 mb-4 opacity-80 hover:opacity-100 transition-opacity flex flex-col">
            <div className="flex justify-between items-center mb-1 pr-2 shrink-0">
